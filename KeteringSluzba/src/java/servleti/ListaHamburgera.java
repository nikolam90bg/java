...
public class ListaHamburgera extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            String upit = "SELECT sifra,naziv,slika,opis,cena,(select count(*) from korpa) as br from hamburger ORDER by sifra,naziv,slika,opis,cena";
            ...
            request.setAttribute("listaHamburgera", lp);
            RequestDispatcher rd = request.getRequestDispatcher("hamburger.jsp");
