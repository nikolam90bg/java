 ...
 * @author Nikola90
 */
public class ListaPasta extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String upit = "SELECT sifra,naziv,slika,opis,cena,(select count(*) from korpa) as br from pasta ORDER by sifra,naziv,slika,opis,cena";
            ...
            request.setAttribute("listaPasta", lp);
            RequestDispatcher rd = request.getRequestDispatcher("pasta.jsp");
