<%-- 
    Document   : dodajHamburger
    Created on : Feb 16, 2016, 6:36:37 PM
    Author     : Nikola90
--%>
...
<html>
    <head>
        ...
        <title>.::Dodaj hamburger::.</title>
    </head>
    <body>
        <div class="back">
            <a href="ListaHamburgera">X</a>
        </div>
        <div id="header">
            <div id="header-meni">
                <div id="logo">
        ...
        <div class="forma">
            <form action="DodajHamburger" method="post">
                <table>
                    <caption>
                        <h2>Dodaj hamburger</h2>
